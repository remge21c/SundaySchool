...
- [X] 반 생성 다이얼로그 정상 표시
- [X] 부서 드롭다운에 옵션 표시 (유년부, 초등부, 중등부, 고등부)
- [X] 담임 교사 드롭다운에 교사 목록 표시
  - [X] 교사 이름과 이메일이 함께 표시 (예: "홍길동 (hong@example.com)")
  - [X] "미배정" 옵션 표시
- [X] 반 생성 성공 시 목록에 새 반 추가
- [X] 성공 메시지 또는 시각적 피드백 표시
